...
<script>
  ...
  async function finish() {
    try {
    	  ...
    	  document.getElementById("download").innerHTML = "Compiling"
    	  ...
    	  project.file("levels/Level 1/Level.sqlite", db.export());scrollbars
          ...
          let progress = document.getElementById("progress");
      	  let s = 0;
    	  project.generateAsync({type : "base64"}, function(onUpdate) {
            ...
            a.download = "export.tap";
            a.href = 'data:application/zip;base64,' + file;
            window.download = "export.tap";
          });
...
var whereQuery;
var prevMenu;
var hideIds = ["projectData", "errorMenu", "icon", "download", "downloadBack", "sceneEditor", "sceneSelector", "objectSelector", "objectEntries", "objectEditor", "behaviorOptions"];
